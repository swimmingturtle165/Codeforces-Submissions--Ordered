...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ll r,c;
        cin>>r>>c;
        bool flg=false,flgt=true;
        vector<vector<int>>inp(r,vector<int>(c)),row_sum(r,vector<int>(c)),col_sum(r,vector<int>(c));
        FOR(i,0,r)
        {
            FOR(j,0,c) 
            {
        ...
        else
        {
            bool flg1=false;
                ...
                if(col_sum[r-1][0]==r*('A') ||col_sum[r-1][c-1]==r*('A'))
                {
                    flg1=true;
                }
            
            
                if(row_sum[0][c-1]==c*('A') || row_sum[r-1][c-1]==c*('A'))
                {
                    flg1=true;
                }
            ...
            {
                bool flagt=false;
                if(inp[0][0]=='A' || inp[r-1][0]=='A' || inp[0][c-1]=='A' ||inp[r-1][c-1]=='A' )
                {
                   flagt=true;
                }
                            FOR(i,0,c)
            {
                if(col_sum[r-1][i]==r*((int)'A'))
                {
                    flagt=true;
                }
            }
