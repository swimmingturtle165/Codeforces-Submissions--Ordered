...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        // cout<<cnt<<endl;
        if(cnt1+n-cnt1>cnt2+m-cnt2 || cnt1>cnt2  || n>m ||cnt<n)
        {
            cout<<"YES"<<endl;
        }
        else 
        {
            ...
            FOR(i,0,n)
            {
                if(n-strg1.order_of_key({inp1[i],0})>m-strg2.order_of_key({inp1[i],0}))
                {
                   cout<<"YES"<<endl;
                   return 0; 
                }
