...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        // dispvector<ll>(strg);
        // cout<<"************************"<<endl;
        // dispvector<ll>(left_maxi);
        // cout<<"************************"<<endl;
        // dispvector<ll>(left_mini);
        // cout<<"************************"<<endl;
        // dispvector<ll>(right_maxi);
        // cout<<"************************"<<endl;
        ...
        while(m--)
        {
            ...
            // else if(left==1)
            // {
            //     if(right_mini[right+1]>0 || right_maxi[right+1]<0)
            //     {
            //     cout<<right_maxi[right+1]+2-right_mini[right+1]<<endl;

            //     }
            //     else
            //     {
                    
            //     cout<<right_maxi[right+1]+1-right_mini[right+1]<<endl;
            //     }
                
            // }
            // else if(right==n)
            // {
            //     cout<<left_maxi[left-1]+1-left_mini[left-1]<<endl;
            // }
            // else
            // {
